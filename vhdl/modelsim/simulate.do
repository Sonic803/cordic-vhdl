...
radix define ufixed8 -fixed -fraction 8 -base 10 -precision 5
radix define fixed13 -fixed -signed -fraction 13 -base 10 -precision 5
radix define fixed14 -fixed -signed -fraction 14 -base 10 -precision 5
...
add wave -position end -radix ufixed8 sim:/cordic_tb/cordic_inst/rho
...
add wave -position end -radix fixed14 sim:/cordic_tb/cordic_inst/x_t
add wave -position end -radix fixed14 sim:/cordic_tb/cordic_inst/y_t
