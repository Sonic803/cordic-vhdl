...
\cadm{need to draw conclusions on the worst paths, clock obtained and theoretical maximum clock. Also the fact that this implementation respect all the requirements set in \ref{sec:algorithm_implementation} in terms of low area occupation and low power consumption}