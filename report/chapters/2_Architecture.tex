...
\begin{center}
    ...
    \end{tikzpicture}
    \vspace{10pt}
    \captionof{figure}{Schematic representation of an FPGA. The grid represents the available logic blocks, with colored outlines indicating resource usage. The CORDIC block is highlighted as a small portion of the total FPGA area.}
\end{center}
\vspace{10pt}
